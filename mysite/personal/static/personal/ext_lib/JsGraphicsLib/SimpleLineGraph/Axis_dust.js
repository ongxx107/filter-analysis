...
SimpleLineGraph.Axis.prototype = {
	...
	draw: function(painter, offX, offY, scalex, scaley, precisionFactor) {
		...
		painter.jsPainter.drawString(this.yLabel, x00 - (this.yLabel.length + new String(precisionFactor).length) * 8 - 5, (this.maxy - this.orginy)*scaley/2 * -1 + offY);
		painter.jsPainter.drawString(this.yLabel2, x00 - (this.yLabel2.length + new String(precisionFactor).length) * 8 - 5, (this.maxy - this.orginy)*scaley/2 * -1 + offY + 15);
	},
	toString: function() {
